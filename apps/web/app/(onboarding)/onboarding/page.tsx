            ...
            <div className="w-full max-w-4xl">
                ...
                <div className="bg-[#1A1A1A] rounded-2xl p-6 md:p-8 border border-gray-800">
                        ...
                        <form onSubmit={handleCreateOrganization} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-[#2A2A2A] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#8b3a62] focus:border-transparent"
                                    required
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="w-full px-4 py-3 bg-[#2A2A2A] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#8b3a62] focus:border-transparent resize-none"
                                />
                            </div>

                            <div className="bg-[#2A2A2A] p-4 rounded-lg border border-gray-700">
                                <p className="text-sm text-gray-400">
                                    <strong className="text-white">Note:</strong> You will be the owner of this
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-[#8b3a62] hover:bg-[#9d4572] text-white font-medium py-3 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                    ...
                    {activeTab === "join" && (
                        <form onSubmit={handleJoinOrganization} className="space-y-6">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-3 bg-[#2A2A2A] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#8b3a62] focus:border-transparent text-lg tracking-widest"
                                        required
                                        maxLength={6}
                                    />
                                </div>
                            ...
                            <div className="bg-[#2A2A2A] p-4 rounded-lg border border-gray-700">
                                <p className="text-sm text-gray-400">
                                    <strong className="text-white">Need a PIN?</strong> Ask your organization owner
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-8">
                    <div className="bg-[#1A1A1A] p-4 rounded-lg border border-gray-800">
                        <h3 className="text-white font-medium mb-2">Creating an Organization</h3>
                    ...
                    <div className="bg-[#1A1A1A] p-4 rounded-lg border border-gray-800">
                        <h3 className="text-white font-medium mb-2">Joining an Organization</h3>
                        <p className="text-gray-400 text-sm">
