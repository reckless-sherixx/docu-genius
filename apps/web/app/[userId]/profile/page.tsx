    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <div className="mb-8">
                <button
                    onClick={() => router.back()}
                    className="inline-flex items-center gap-2 text-gray-600 hover:text-[rgb(132,42,59)] mb-4 transition group"
                >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div className="px-6 pb-6">
                    <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-12">
                        ...
                        {/* Name & Email */}
                        <div className="flex-1 sm:mb-2 sm:pt-14">
                                ...
                                {isEditingName ? (
                                    <div className="flex items-center gap-3 bg-gray-50 rounded-lg px-3 py-2">
                                        <input
                                            ...
                                            className="text-xl font-bold text-gray-900 bg-transparent focus:outline-none min-w-[150px]"
                                            autoFocus
                                        />
                                        <div className="flex items-center gap-1">
                                            <button
                                                ...
                                                disabled={savingName}
                                                className="p-1.5 text-white bg-green-500 hover:bg-green-600 rounded-md transition"
                                            >
                                                {savingName ? (
                                            ...
                                            <button
                                                ...
                                                className="p-1.5 text-white bg-gray-400 hover:bg-gray-500 rounded-md transition"
                                            >
                                                <X className="h-4 w-4" />
                                            </button>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-2 group">
                                        ...
                                        <button
                                            ...
                                            className="p-1.5 text-gray-400 hover:text-[rgb(132,42,59)] hover:bg-[rgb(132,42,59)]/10 rounded-md transition opacity-0 group-hover:opacity-100"
                                        >
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100">
                        <div className="space-y-5">
                                ...
                                <div className="flex items-center gap-3">
                                    {pin.map((digit, index) => (
                                        <input
                                            ...
                                            className="w-14 h-14 text-center text-2xl font-bold border-2 border-gray-200 rounded-xl focus:border-[rgb(132,42,59)] focus:ring-2 focus:ring-[rgb(132,42,59)]/20 focus:outline-none transition bg-gray-50"
                                            maxLength={1}
                                        />
                                    ))}
                                    <button
                                        ...
                                        className="ml-2 p-2.5 text-gray-400 hover:text-[rgb(132,42,59)] hover:bg-[rgb(132,42,59)]/10 rounded-lg transition"
                                    >
                            ...
                            <button
                                ...
                                disabled={savingPin}
                                className="w-full py-3 bg-[rgb(132,42,59)] hover:bg-[rgb(112,32,49)] text-white font-medium rounded-xl transition disabled:opacity-50 flex items-center justify-center gap-2 shadow-sm"
                            >
                                {savingPin ? (
                                    <>
                                        <Loader2 className="h-4 w-4 animate-spin" />
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="space-y-3">
                    {profile.organizations.map((org) => (
                        <div
                            key={org.id}
                            className="p-4 rounded-xl border-2 transition border-gray-100 hover:border-gray-200"
                        >
